# Product Requirements Document — V1 (Archived Deep Version)
## Vigil — Agentic Incident Commander for Network Operations

> **This is the full-length PRD (~611 lines, ~30 min read).** For the 10-minute leadership-facing version, see [`docs/prd.md`](./prd.md). V1 is preserved here as the deep-reference archive — every diagram, every phase deep dive, every architecture detail, every Roadmap row, every Cisco AI Canvas integration point.

**Status:** Shipped (prototype with mock data)
**Audience:** Deep technical / architectural reference
**Author:** Bharat Namatherdhala
**Date:** May 2026 (archived June 2026)
**Companion documents:** [`docs/prd.md`](./prd.md) (10-min current version) · [`docs/director-brief.md`](./director-brief.md) (5-min Director read) · [`docs/jon-elli-brief.md`](./jon-elli-brief.md) (15-min peer PM read) · [`docs/competitive-landscape.md`](./competitive-landscape.md) · [`docs/model-evaluation.md`](./model-evaluation.md)
