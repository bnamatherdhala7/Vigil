...
- **[`docs/splunk-frontier-models-30-60-90.md`](./docs/splunk-frontier-models-30-60-90.md)** — 30/60/90 day plan for the Splunk frontier-models role (log reasoning · time-series · observability foundation models)
